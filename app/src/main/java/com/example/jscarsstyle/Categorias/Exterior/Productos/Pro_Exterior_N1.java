...
public class Pro_Exterior_N1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pro_exterior_n1);
        ...
        cargar = (Button)findViewById(R.id.btt_agregar_pro1_ext);
        ...
        databaseReference.child("Stock").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot op : snapshot.getChildren()){
                    ...
                    String pro = obj_ext.getNombreExterior()[0];
