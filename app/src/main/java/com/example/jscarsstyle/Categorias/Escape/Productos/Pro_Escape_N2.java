...
public class Pro_Escape_N2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pro_escape_n2);
        ...
        agregar = (Button)findViewById(R.id.btt_agregar_pro2_esca);
        ...
        databaseReference.child("Stock").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot op : snapshot.getChildren()){
                    ...
                    String pro = obj_esca.getNombreEscape()[1];
